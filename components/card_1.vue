<template>
  <div>
    <div class="top_card fs12 mb15 shadow_gray pb28 posre" v-if="type == 'plus'">
      <div class="pl34 pt25 cblue fs12"><span class="before_line_3">{{card_msg.company || '机构名称'}}</span></div>
    ...
    <div class="pt15 pl16 pr15 pt16 bgfff pb15" v-else @click="page_turn('index')">
      <div class="top_card fs12 shadow_gray pb42" style="position: relative;background-color: white;">
        <div class="pl34 pt25 cblue fs12"><span class="before_line_3">{{card_msg.company || '机构名称'}}</span></div>
        <div class="top_msg disflex jsbet pt40">
          ...
          <div class="disflex">
            <img :src="card_msg.picchecked || card1_logo" alt="" mode="aspectFill" class="w100 h100 bradius5" />
          </div>
        </div>
      </div>
    </div>
