  ...
  <div>
    ...
    <div class="disflex bgfff jsbet pl15 pr15 mt11 pt20">
      ...
      <!--   <div class="be8 lh25 pl9 pr10 bradius3 fs12 c80" @click="echart_time_tap('active')">
             近15天
             <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/down.pngg" alt="" class="w10 h10">
         </div>-->
    </div>
    ...
    <div class="disflex fix_bottom bte8"
      ...
      <div class="disflex flex1 bgfff pt8 textc">
        <div class="w33p"
             @click="makePhone">
          <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/tel_gray.png"
               alt=""
               class="w20 h20" />
        ...
        <div class="w33p"
             @click="addWx">
          <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/wx.png"
               alt=""
               class="w20 h20" />
      ...
      <div class="w220 disflex textc fs16 cfff pr15 pt5 pb5 borderbox bgfff lh40">
        ...
        <span class="flex1 bg_line_blue bra_right_20"
              ...
              @click="page_turn('companyPack/clientAdd' , '?type=userAdd&cardId='+(cardMsg.analysisModel.cardId || '')+'&userId='+(cardMsg.analysisModel.userId || ''))">存为客户</span>
      </div>
    </div>
    ...
    <cover-view class="disflex fix_bottom bte8"
      ...
      <cover-view class="disflex flex1 bgfff pt8 textc">
        <cover-view class="w33p textc"
                    @click="makePhone">
          <cover-image src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/20190509101137.png"
                       alt=""
                       class=" disinblock make-phone" />
        </cover-view>
        <cover-view class="w33p textc"
                    @click="addWx">
          <cover-image src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/20190509101149.png"
                       alt=""
      ...
      <cover-view class="w220 disflex textc fs16 cfff pr15 pt5 pb5 borderbox bgfff lh40">
        <template v-if="cardMsg.analysisModel.isMyCustomer <= 0">
          <cover-image src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/20190509101156.png"
                       alt=""
                       class=" disinblock concat-client"
                       @click="toIM" />
          <cover-image src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/20190509101201.png"
                       alt=""
                       class=" disinblock save-client"
                       @click="page_turn('companyPack/clientAdd' , '?type=userAdd&cardId='+(cardMsg.analysisModel.cardId || '')+'&userId='+(cardMsg.analysisModel.userId || ''))" />
        </template>
        <template v-else>
          <cover-image src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/20190509101323.png"
                       alt=""
    ...
    <cover-view style="display: none">
      <cover-image src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/20190509101137.png"></cover-image>
      <cover-image src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/20190509101149.png"></cover-image>
      <cover-image src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/20190509101156.png"></cover-image>
      <cover-image src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/20190509101201.png"></cover-image>
      <cover-image src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/20190509101323.png"></cover-image>
    </cover-view>
    <div class="h49"></div>
    <!--客户兴趣时间选择-->
