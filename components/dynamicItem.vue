<template>
    <div class="disflex jsbet bgfff pt20 pl15 pr16 pb15 bbf5f6">
        <img :src="dynamic_item.companyLogo || 'https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/user/card1_logo.png'" alt=""
             mode="aspectFill"
        ...
        <div class="flex1">
            <p class="disflex cdeepblue fs16 jsbet lh27">
                ...
                <!-- <button class='bgfff fs12 cdeepblue p0' hover-class="other-button-hover" @click.shareClick="shareClick(index1)">
                    <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/user/share.png" alt="" class="w16 h16" />
                </button> -->
            ...
            <div v-if="dynamic_item.type == 1">
                    ...
                    <div class="posab  dynamic_operate" :class="dynamic_item.operate_show ? '' : 'w0' ">
                        <div class="w178 bg38 pl25 pr28 disflex jsbet">
                            <div class=" disflex align-cen" @click.stop="zan(index1 , dynamic_item.isThumbs)">
                                <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/user/zan_fff.png" alt="" class="w20 h20" />
                                <span class="fs14 cfff pl8">{{dynamic_item.isThumbs == 1 ?'已赞':'赞'}}</span>
                            </div>
                            <div class="disflex align-cen" @click.stop="addComment(index1)">
                                <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/user/talk.png" alt="" class="w20 h20"/>
                ...
                <div class="bgf5f6 pl10 pr10 fbold pt9 pb9 cdeepblue fs16"  v-if="dynamic_item.doThumbsNum > 0">
                    <div class="dynamic_likes ">
                        <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/user/zan.png" alt="" class="w20 h20 mr8 posre top4" />
    ...
    export default {
      ...
      components:{StaticResources},
        methods:{
            ...
            toDetail(){//查看文章详情
                let url = '../article/dynamicDetail/main?dynamicId=' + this.dynamic_item.dynamicId;
