  ...
  <div @click="row_tap">
    <div class="disflex jsbet pl15 pr15 bgfff pt15 pb15" :class="bradius">
      <div class="pr10 posre">
        <img :src="msg.logo || 'https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/card1_user.png'" alt=""  mode="aspectFill" class="w50 h50 bradius5" />
      ...
      <div class="flex1">
        <div class="disflex jsbet ">
          <div>
            <span class="fs18 c38 pr7 over_1 disinblock over_1" >{{msg.name || msg.nickName}}</span>
          ...
          <div class="disflex fs14 cblue" v-if="edit" @click="edit_tap">
            <p>编辑</p>
            <img class="disflex w15 h15 ml7 mt2" :src="iconEdit">
          </div>
        </div>
        <!--行为记录-->
        <div class="disflex jsbet cbc fs14" v-if="isaction"><!--type == 1 || type ==   5-->
          ...
          <span class="icon">
            <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/msg.png"
                 alt=""
                 @click.stop="toIM"
...
<script>
  ...
  export default {
    ...
    props: ['msg', 'type', 'bradius','isaddLog','isrightpoint','ismsg','isrank',
      ...
      'islogtitle','isport','isusertag','actionType','index' ,'telReverse', 'isShowFollow','edit'],
    // type :  1 -- 显示信息 ， 2 -- 不显示信息
    ...
    data() {
      return{
        ...
        iconEdit:WXAJAX.imgBackUrl+'yimai_photos/crmRevision/ic_ edit.png'
      }
    },
    mounted() {
    },
    ...
    methods: {
      ...
      row_tap() {
        ...
        wx.setStorageSync("AIUserId", this.msg.userId);
        this.$emit('row_tap' , this.msg.cardId , this.msg.userId , this.msg.customerState , this.msg.ascriptionName)
      },
      page_turn(url,query){
        query = query || '' ;
