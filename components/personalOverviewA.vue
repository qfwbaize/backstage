<template>
  <div>
    ...
    <div class="bgfff pb20">
      ...
      <div class="turnover_btn">查看更多数据</div>
    </div>
    ...
    <div v-show="pandect_show">
      ...
      <div class="bgfff">
        ...
        <div class="disflex fd align-cen cfff fs12 pb4">
          <div class="textc trapezoid posre trapezoid1">
            <span>{{turnoverRate[k+1] || 0}}</span>
          </div>
          <div class="textc trapezoid posre trapezoid2">
            <span>{{turnoverRate[k+1] || 0}}</span>
          </div>
          <div class="textc trapezoid posre trapezoid3">
            <span>{{turnoverRate[k+1] || 0}}</span>
          </div>
          <div class="textc trapezoid posre trapezoid4">
            <span>{{turnoverRate[k+1] || 0}}</span>
          </div>
        </div>
    ...
    <div :style="{height : active_show ? 'auto' : '0'}" class="trans2 overhidden">
      ...
      <div class="bgfff">
        <p class="fs14 c38 fbold textc lh44">客户与{{menu_id == 2 ? '机构' : '我的'}}互动</p>
