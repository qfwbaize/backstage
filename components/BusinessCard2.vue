    ...
    <div class="top_card fs12  shadow_gray posre" v-if="type == 'plus'">
      ...
      <div class="top_msg zIndex100 disflex pt15"  @click="page_turn('index')">
        ...
        <div class="pl10 info-content pt10">
          ...
          <p class="fs14 ca8 pt10 pb25">{{card_msg.remark || '备注'}}</p>
        </div>
      ...
      <div class="flex-sa-c btf5f6 operate-bottom">
          <div v-if="!isLogin" class="phone flex-c-c" @click.self="makePhone">
            <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/user/tel.png"
               alt="" class="w16 h16 mr11 pl3 pr3">
            <span class="fs14 ca8">拨打电话</span>
          </div>
          <button class="phone flex-c-c" v-else-if="isLogin && !phone" open-type="getPhoneNumber" @getphonenumber="getPhoneNumber">
            <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/user/tel.png"
               alt="" class="w16 h16 mr11 pl3 pr3">
            <span class="fs14 ca8">拨打电话</span>
          </button>
          ...
          <button class='bgfff contentbox share-button flex-c-c'
                  id="111"
                  ...
                  :data-logo="card_msg.company_logo"
                  :data-shareSpeech="card_msg.shareSpeech||''"
                  @click.stop="stopClick"
                  open-type="share">
            <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/user/card-case-forward-square2.png" alt="" class="w16 h16 mr11">
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      page_turn(url){
        // wx.setStorageSync('isself', '1');/*id*/
        // wx.setStorageSync('COMPANYID',this.card_msg.companyId);/*id*/
        // wx.setStorageSync('CARDID',this.card_msg.cardId);/*id*/
        // wx.switchTab({url:'../'+url+'/main?cardId='+this.card_msg.cardId+'&companyId+'+this.card_msg.companyId});
      },
      moreTap(){
