<template>
  <div class="create-task">
    <view class="title c38">关联主任务</view>
    <view class="childmain">
      <view class="childText">{{mainTitle}}</view>
      <view class="minList_status">
        <state :status='mainStatus'></state>
      </view>
    </view>
    <view class="title c38">子任务</view>
    <div class="content-wrap">
      ...
      <div class="target" v-show="index == 2" style="margin-bottom:20rpx;">
        ...
        <ul>
          ...
          <!-- <li style="font-weight: bold;justify-content: left;">
            可承接人数
            <input class="numpeople" v-model="peopleNum" style="width: 288rpx;height: 60rpx;" type="number" />
            人
          </li> -->
        </ul>
      </div>
      ...
      <div class="target">
        ...
        <div class="content">
          <div class="choice-article c39">{{dynamicName}}</div>
...
<script>
  ...
  export default {
    ...
    onLoad(option){
      this.pid = option.pid
      this.mainTitle = option.title
      this.mainStatus = option.status
      this.pattern = option.pattern
      this.dynamicid = option.dynamicid
      this.getEnclosure(option.dynamicid)
    },
    onUnload() {
      this.destroyed()
    },
