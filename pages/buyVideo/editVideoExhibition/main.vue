    ...
    <div>
        <div>
            ...
            <div class="disflex jsbet" v-if="videoItem.url == ''">
                <div class="bgfff textc h49 lh49 fs16 cblue btf5f6 bbf5f6 flex1" @click="chooseTypeShow = true">添加视频内容</div>
            </div>
            <div class="disflex jsbet" v-else>
                <div class="bgfff textc h49 lh49 fs16 cblue btf5f6 bbf5f6 flex1" @click="chooseTypeShow = true">变更视频内容</div>
            ...
            <div class="bgfff textc pt25 borderbox">
                <div v-if="videoItem.url != ''">
                    ...
                    <div v-else class="w100p h212 posre" @click="playVideo = true">
                        <img :src="videoItem.cover || 'https://myy-one-stand.oss-cn-beijing.aliyuncs.com//one-www/photo/20190604/1559619324240.png'" mode="aspectFill" alt="" class="w100p h212">
                ...
                <img v-else src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com//one-www/photo/20190522/1558493217500.png" alt="" mode="aspectFill" class="w100 h100">
        ...
        btn_tap() { // 保存视频添加的视频
          ...
          if (this.$root.$mp.query.type == 'edit') {
            WXAJAX.POST({
              ...
              videoId: this.videoItem.videoId}, '', '/businessCardVideo/uodVideo'
            ).then(res => {
              wx.hideLoading();
              wx.showToast({
                title: '保存编辑视频成功',
