<template>
  <div>
        ...
        <div class="disflex jsbet flex1">
          <div class="addr_detail">
              <p class="fs16 c38 fbold">
                <span>{{cart_lists[0].receiveName}}</span>
                <span style="margin-left:8px;"> {{cart_lists[0].receivePhone}}</span>
              </p>
    ...
    <div class="mb10 order_detail_addr">
      <AddressItem :addr="default_addr" :noJump="true">
      </AddressItem>
    </div>
    <!--商品-->
    ...
    <div class="disflex jsbet bbf5f6 pl16 pr17 c38 lh44 bgfff">
      ...
      <span class="fs14 fbold">￥{{(cart_lists[0] ? cart_lists[0].orderPrice ? cart_lists[0].orderPrice :0 : 0) / 100}}</span>
    </div>
    <div class="disflex jsbet pl16 pr17 c38 lh44 bgfff" v-if="orderState != 1">
      <span class="fs16">实付款</span>
      <span class="fs16 corange fbold">￥{{ (cart_lists[0] ? cart_lists[0].payPrice ? cart_lists[0].payPrice : 0 : 0) / 100}}</span>
    </div>
    ...
    <div class="bgfff lh44 fs16 c38 mb15 mt10">
      ...
      <div class="lh44 pl20 bgfff fs14 c38 disflex align-cen" v-if="order_type == 6">
        <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/refund.png" alt="" class="w16 h16 mr7" />
