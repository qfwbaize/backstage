...
.today-overview {
  ...
  padding: 40upx 32upx 38upx 32upx;
}
...
.today-overview .data-pic .item1 {
  background: url("https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/ai-track/bg1%402x.png")
    no-repeat center;
  background-size: 210upx;
}
.today-overview .data-pic .item2 {
  background: url("https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/ai-track/bg2%402x.png")
    no-repeat center;
  background-size: 210upx;
}
.today-overview .data-pic .item3 {
  background: url("https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/ai-track/bg3%402x.png")
    no-repeat center;
  background-size: 210upx;
}
