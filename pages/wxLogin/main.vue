...
<script>
    ...
    export default {
        name: "login",
        props: [],
        components: {StaticResources, AppNotice, Login},
        data () {
            return {
        ...
        methods: {
            ...
            loginSuccess () {
              wx.setStorageSync("isLogin", true);
                ...
                if(url.indexOf('pages/companyPack/clientAdd/main')>=0||url.indexOf('/pages/companyPack/find/dynamicDetail/main')>=0){
                  return;
                }
                if(this.redirectUrl){
            ...
            cancelLogin () {
                // 取消登录跳转回来的界面
                const url = this.redirectUrl + '?notYetLogin=true';
