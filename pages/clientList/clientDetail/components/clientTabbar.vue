...
export default {
  props:['logs', 'deallogs' , 'moneyLog' ,'type', 'istop' , 'isTopTitle','isInFollowLog', 'firstLog', 'isShowAdd', 'userId', 'current' , 'msg', 'cardId'],
 ...
 methods:{
  ...
  //  },
    ...
    exportlist(){//导出PDF文档
     ...
     // console.log({
     //    srcPath:'http://test1.mingyicloud.com/card/follow/customer.html?token='+wx.getStorageSync('token')+'&isBoss='+isBoss+'&customerId='+this.cardId,
     //    destPath:'1.pdf',
     //  })
      // return ;
      WXAJAX.POST({
        srcPath:'http://test1.mingyicloud.com/card/follow/customer.html?token='+wx.getStorageSync('token')+'&isBoss='+isBoss+'&cardId='+this.cardId,
        destPath:'1.pdf',
