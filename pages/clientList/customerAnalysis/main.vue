<template>
  <div class="h100p borderbox customer">
    <div class="bgblue textc posre"
      ...
      <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/ai-track/left-arrows%402x.png"
           alt=""
           @click="back"
           class="w20 h20 back">
    </div>
    ...
    <scroll-view scroll-y="true"
      ...
      <div class="user-info bgblue">
        <img :src="userInfo.analysisModel.logo||'https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/user/user_default_avatar_square.png'"
...
export default {
  ...
  onLoad (query) {
    console.log(query,"dgewgewewfiewfgewfgewow")
