<template>
  <div class="w100p minh117p bgf5f6">
    ...
    <div class="bgfff pl15 pb10 pr15">
      <div class="bgf5f6 bradius17 textc lh34 disflex align-cen pl25 search trans2" :class="isfocus ? 'focus' : '' ">
        <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/user/search.png" alt="" class="w16 h16">
        <input type="text" v-model="searchkey" placeholder="搜索姓名/电话号码" class="ca8 fs14 lh34 h34 textl pl10 w160 trans2"
          @focus="search_focus" @confirm="search_confirm">
      </div>
    </div>
    ...
    <div class="bgf5f6 pt15 pl16 pr15">
      ...
      <div class="bradius10 bgfff " v-if="card_msg">
        <Card1 :card_msg="card_msg" :type="'plus'" :hasCard="hasCard" :isdel="false" :index="1" @page_turn="toIndex"
      ...
      <div v-if="lists.length>0">
        <div class="bradius10" v-for="(v,k) in lists" :key="k">
          ...
          <div class="bgfff bradius10">
            <Card1 :card_msg="v" :type="'plus'" :hasCard="false" :isdel="true" :index="k+2" @moreTap="moreTap"
              @page_turn="toIndex" @shareApp="shareApp"></Card1>
          </div>
        </div>
      </div>
      ...
      <div class="add_card">
        ...
        <div class="disflex overhidden jsbet bgblue trans2 bradius30 cfff fs18 lh60 pl21 pr22 mb10" @click="page_turn('editCard')"
          ...
          <div class="disflex align-cen">
            <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/user/add.png" alt="" class="w30 h30 mr11">
            <span>我的智能名片</span>
          </div>
        ...
        <div class="textc disflex w60 h60 bradius50p bgblue disinblock" @click="addInfo = !addInfo" v-if="!hasCard">
          <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/user/add.png" alt="" class="w30 h30 mt15 ">
        </div>
    ...
    <div v-if="operateShow">
      <SelectorOne :title="'操作'" :status="operateShow" :allClass="operateTypes" @closeModal="operateShow = !operateShow"
  ...
  export default {
    ...
    methods: {
      shareApp(companyId, cardId) {
        this.onShareAppMessageTo(companyId, cardId)
      },
      search_focus() {
        this.isfocus = true;
      },
