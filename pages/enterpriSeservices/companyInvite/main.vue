<template>
  <div class="h100p bgfff">
    <p class="fs18 c38 fbold pt30 pb25 textc bgfff">
      Hi！<span class="cblue">{{companyInfo.name}}</span> 邀请你加入以下机构
    </p>
      ...
      <div class="shadow_gray pt15  pb11  bgfff fs12 ca8">
        ...
        <div class="disflex jsbet lh45 pr15 pl15 align-cen">
          <div class="disflex align-cen" @click="isShowNotice=true">
            <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/notice.png" alt="" class="w16 h16 mr8" />
...
<!--            <span>{{companyInfo.companyNotice}}</span>-->
        ...
        <div class="btf7 disflex jsbet pl47 pr47 fs10 ca8 pt10 textc">
          <div>
            <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/prod_gray.png" alt="" class="w24 h24" />
            <p>产品</p>
          </div>
          <div>
            <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/browser_gray.png" alt="" class="w24 h24" />
            <p>动态</p>
          </div>
          <div>
            <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/computer_gray.png" alt="" class="w24 h24" />
            <p>官网</p>
          </div>
        </div>
      </div>
    ...
    <div class="disflex jscen pt50 wrap">
      ...
      <span class="bg_line_blue cfff textc fs18 fbold bradius5 lh44 mb15 w290" @click="joinCompany">立即加入该机构</span>

      <span class="bblue cblue fs18 lh44 textc w290 bradius5" @click="createCompany">我的机构</span>

    </div>

    <!--提示弹框-->
    <div v-show="dialog_show">
      <DialogBox :dialog_title="'提示'" @btn_tap="hint_btn_tap" :dialog_ph="'你还没有归属机构哦，是否去创建自己的机构？'"
                 :type = "'hint2'"
    ...
    methods: {
      joinCompany (){
        if(this.isCreateCompany) {
          wx.navigateTo({url: `/pages/companyPack/editCard/main?invite=1&type=add`});
        } else {
          wx.showToast({
            title: '您已加入其它机构',
            icon: 'none'
      ...
      hint_btn_tap(method,text){
        ...
        if(method == 'save'){
          wx.navigateTo({url: '/pages/companyPack/editEnterprise/main'});
        }
      },
      getCompanyInfo() {
