<template>
  <div class="disflex jsbet align-cen pl15 pr15 pt15 pb15 bgfff line" :class="className">
    <div class="disflex align-cen">
      <img :src="orderInfo.avatarUrl || 'https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/user/card1_user.png'" class="user-head mr10" alt="">
      <div>
        ...
        <div class="fs12 ca8 mt5">
          ...
          剩余
          <CountDown
            :diffTime="parseInt(orderInfo.assembleEndTime/1000)"
            type="2"
          />
          结束
        </div>
