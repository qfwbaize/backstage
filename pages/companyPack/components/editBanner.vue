<template>
    <div class="w100p h211">
                    ...
                    <swiper-item>
                        ...
                        <div class="tags">
                            <span class="w30 h30 del disflex align-cen jscen mb10" >
                                <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/del.png" alt="" class="w17 h17" />
                            </span>
        ...
        <div v-else class="w100p h100p bgf5f6 textc pt30" @click="uploadpic(-1)">
            <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/VR.png" alt="" class="w100 h100 mb5" />
