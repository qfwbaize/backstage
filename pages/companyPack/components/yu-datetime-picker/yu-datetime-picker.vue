<template>
	<view class="yu-datetime-picker">
		<view class="yu-datetime-mask" :class="{'maskshow':showPicker}" @tap="maskClick" @touchmove.stop.prevent catchtouchmove="true"></view>
		<view class="yu-datetime-content" :class="{'contentshow':showPicker}">
