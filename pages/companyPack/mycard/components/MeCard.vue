    ...
    <div class="top_card fs12 mb15 shadow_gray pb25" v-if="type == 'plus'">
      ...
      <div class="disflex jsbet pl25 pt25 share_p">
        <span class="w60 lh20 ba8 bradius10 textc fs12 ca8" v-if="hasCard">我的名片</span>
          ...
          <button class='w16 pl5 h16 bgfff contentbox flex-sa-c share'
                  id="111"
                  ...
                  open-type="share">
            <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/user/icon_share.png" alt="" class="w10 h10">
...
<style scoped>
  .flex-sa-c{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-justify-content:space-around;-ms-flex-pack:distribute;justify-content:space-around;-webkit-box-align:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center}
  .out{
    line-height: 1;
    border-radius: 20upx;
