<template>
  <div class="insert-card">
    <button v-if="!isLogin" class="insert" open-type="getUserInfo" @getuserinfo="GetUserInfo">
      <div class="left">
        <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/user/add.png" alt />
...
export default {
  ...
  methods: {
    updateMyCard() {
      wx.navigateTo({ url: "/pages/enterpriSeservices/chooseIdentity/main?goType=1" });
      // wx.navigateTo({ url: "../companyPack/editCard/main?type=add" });
      // this.toCreatePage();
    },
    /**
     * 获取用户信息
