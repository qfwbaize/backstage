    ...
    <div class="pb70" v-if="classify.length">
      ...
      <div v-for="(v,k) in classify" :key="k"  class="bgfff ">
        ...
        <div class="disflex jsbet pr11 align-cen" @click="open_lists(k)">
          ...
          <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/up.png" alt="" class="w10 h10" v-if="v.open" />
          <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/down.png" alt="" class="w10 h10" v-if="!v.open"/>
            ...
            data.forEach(function(i,k){
              ...
              if(i.goodsModelList){
                i.goodsModelList.forEach(function (i2, k2) {
                  ...
                  if(i2.goodPhoto && i2.goodPhoto.indexOf(",") != -1){
                    i2.photo = i2.goodPhoto.split(',')[0];
                  }else{
                    i2.photo = i2.goodPhoto;
                  }
                }) ;
