<template>
  <div class="h100p">
    ...
    <div class="pb70">
      ...
      <div v-for="(v,k) in classify" :key="k" class="bgfff ">
        <div class="disflex jsbet pr11">
          <span class="lh44 pl15 fbold" @click="manage('edit',v.name , v.goodstypeId)">
            {{v.name}}
          ...
          <div class="disflex align-cen">
            ...
            <span @click="to_up(v.goodstypeId , k)">
              <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/toup.png" alt=""
                class="w20 h20 pl10" />
            </span>
          </div>
        </div>
    ...
    <div v-show="dialog_show">
      <DialogBox :dialog_title="dialog_title" @btn_tap="btn_tap" :dialog_ph="dialog_ph" :default="classify_name"
        :left="'取消'" :right="'保存'"></DialogBox>

    </div>

    <div v-if="delDialog">
      <DialogBox dialog_title="提示" @btn_tap="del_tap" dialog_ph="确定要删除该分类吗？" type="hint2" :left="'取消'" :right="'确定'">
      </DialogBox>
    </div>
