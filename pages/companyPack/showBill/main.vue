      ...
      <div v-for="(img,idx) in imgLists" :key="idx">
        <swiper-item class="item">
          <div :class="currentIndex ==  idx ? 'active' : '' " class="itemImg poster2 posre" >
            <img mode="widthFix" :show-menu-by-longpress="true" style="width: 100%" :src="img">
          </div>
        </swiper-item>
      </div>
<!--      <div >-->
...
<!--            <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/poster_2_bg.png" alt="" class="w100p h100p posab left0 top0">-->

<!--            <div class="posre pt113 textc disflex jscen">-->
<!--              <div>-->
<!--                <div class="w103 h103 bradius50p bgfff posre mb88">-->
<!--                  <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/ercode.png" alt="" class="w86 h86 posab left0 right0 top0 bottom0 mauto ">-->
<!--                </div>-->
<!--                <p class="fs7 cfff textc pb40">-此名片海报由采推小程序生成-</p>-->

<!--                <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/user.jpg" alt="" class="w42 h42 bradius5">-->
...
<!--              <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/poster_1_text.png" alt="" >-->
<!--            </div>-->
...
<!--      </div>-->
    ...
    <div class="bgfff disflex fs12 ca8 textc h93 fix_bottom pt11 borderbox">
      <div class="textc w100p" @click="shareToTimeLine">
        <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/time_line_share.png" alt="" class="w50 h50" />
        <p>保存图片</p>
