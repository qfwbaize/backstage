<template>
  <div>
    ...
    <div class="textc bgfff pt16">
      <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/money_2.png" alt="" class="w65 h65 mauto" />
      ...
      <div class="disflex jsaround pl14 pr15 fs14 c38 lh44">
        ...
        <span :class="type == 2 ? 'cblue bbblue_2' : '' " @click="type_tap(2)" v-if="isBoss">机构流水</span>
      </div>
    </div>
    <!--筛选-->
    <div class="disflex jsbet pt15 pr15 pb15 pl15 align-cen">
      <div class="bgfff lh30 pl16 pr15 c38 fs14 bradius15 disflex align-cen">
          ...
          >
            {{chooseMonth}}
            <img src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/down_2.png" alt="" class="w10 h10 ml6"/>
          </picker>
      </div>
      <span class="fs14 cb8">¥{{monthCount || 0.00}}</span>
    </div>
    <!--订单-->
    <!--<scroll-view v-if="order_lists.length > 0"  scroll-y style="height: 55.5vh;background: #fff">
      <div @click="financialDetail(item.inputDealId || '')"  v-for="(item, index) in order_lists"  class="pl15 pt10 pb10 pr15 disflex jsbet align-cen" style="border-bottom: 1upx solid #f5f5f6">
        <div class="disflex align-cen">
          <image :src="item.userPhoto || 'https://myy-one-stand.oss-cn-beijing.aliyuncs.com/yimai_photos/crm/card1_user.png'" class="w40 h40 bradius50p" />
    ...
    <div class="disflex jscen" v-else style="height: 55.5vh;background: #fff">
      <image src="https://myy-one-stand.oss-cn-beijing.aliyuncs.com//one-www/photo/20190521/1558429867593.png" style="height: 340upx;width: 340upx;margin-top: 121upx" />
    </div>-->
