...
<template>
    <div>
        ...
        <div class="disflex jsbet bgfff lh30 pl16 pr15 pt5 pb5">
            <div class="pr15" @click="chooseCity('companyPack/searchChooseItem','city')">
        ...
        <div class="pl16 bgfff pt15 pb15 pr16" v-show="!key">
            ...
            <div class="disflex jsbet pt10">
                <span class="fs16 fbold c38" @click="choose_addr2">{{locat.addr}}</span>
        ...
        <div v-show="key">
            ...
            <div class="bgfff fs14 ca8 pl16 pr16 bbf7 pt15 pb15" v-for="( v,k) in search_lists" :key="k"
                 @click="choose_addr(k)">
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.videoAdd = this.$root.$mp.query.videoAdd
        ...
        methods: {
            ...
            getLocal(latitude, longitude) {
                ...
                v.myAmapFun.getRegeo({
                    ...
                    success: function (data) {
                        ...
                        v.locat.city = _address.city.length?_address.city:_address.province ;
            ...
            choose_addr2(){
              ...
              setTimeout( () =>{
                  wx.navigateBack();
                  wx.setStorageSync('video_address' , this.locat.addr)
                  wx.hideLoading();
              },500)
            },
            choose_addr(index){
                ...
                if(this.videoAdd){
                    setTimeout( () =>{
                        wx.navigateBack();
                        wx.setStorageSync('video_address' , this.search_lists[index].build)
                        wx.hideLoading();
                    },500)
                }else{
                    setTimeout( () =>{
