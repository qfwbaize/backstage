        ...
        <div v-for="(videoItem, index) in videoLists" :key="index">
            ...
            <div class="bgfff textc borderbox h212 overhidden">
                ...
                <div class="w100p h212 posre" @click="showVideo(videoItem.videoId)" v-else>
                    <img mode="aspectFill" :src="videoItem.cover || 'https://myy-one-stand.oss-cn-beijing.aliyuncs.com//one-www/photo/20190604/1559619324240.png'" alt="" class="w100p h212">
...
export default {
    ...
    methods: {
        ...
        toEditVideo(videoItem){
            ...
            wx.navigateTo({
                url: '/pages/enterpriSeservices/editCompanyVideo/main?type=edit'
            })
        },
        btn_tap(){
            wx.navigateTo({
                url: '/pages/enterpriSeservices/editCompanyVideo/main?type=create'
            })
        },
